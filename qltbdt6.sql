...
CREATE TABLE `lichtruc` (
  ...
  `nhanvien_id` int NOT NULL,
  `phong_id` int NOT NULL,
  `caLamViec` enum('Sáng','Chiều','Tối') NOT NULL,
...
INSERT INTO `phong_thietbi` VALUES (35,1,9,177),(36,1,9,178),(38,2,4,160),(44,1,4,161),(46,2,4,162),(49,3,4,163),(50,3,4,164),(51,4,3,155),(52,4,3,156),(53,4,3,157),(54,4,3,158),(55,4,3,159);
...
-- Dump completed on 2025-03-31  6:46:27
