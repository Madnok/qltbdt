...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lưu log các hoạt động bảo trì/sửa chữa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lichbaoduong` (
  ...
  `trang_thai` enum('Chờ xử lý','Đang tiến hành','Hoàn thành','Hủy','Chờ Hoàn Tất Bảo Hành','Chờ Xem Xét') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-04-29 14:47:29
