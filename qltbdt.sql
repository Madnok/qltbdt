...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lưu log các hoạt động bảo trì/sửa chữa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gopy` VALUES (1,'Trải nghiệm người dùng','hơi tệ',0,NULL,'minh hùng','2025-04-22 20:32:42','Đang xử lý','on',2,0,1),(3,'Hiệu năng / tốc độ','fsd',1,NULL,'Ẩn Danh','2025-04-22 22:19:55','Mới',NULL,1,0,1),(4,'Quy trình sử dụng','quy trình hơi khó hiểu cho 1 nhân viên như tôi',0,2,'Phạm Minh Hùng','2025-04-22 22:28:03','Đã phản hồi',NULL,3,0,1),(5,'Tính năng','tốt',0,2,'Phạm Minh Hùng','2025-05-16 12:21:35','Đang xử lý',NULL,2,0,1);
...
INSERT INTO `gopy_comments` VALUES (1,1,2,'tệ ở đâu ạ','2025-04-22 20:44:31'),(2,1,1,'đó là tôi admin','2025-04-22 21:11:04'),(3,5,2,'Cảm ơn bạn','2025-05-16 12:24:59');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lưu lượt vote (hỗ trợ cả user đăng nhập và ẩn danh)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lichbaoduong` (
  ...
  `mo_ta` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Mô tả công việc bảo dưỡng',
  `trang_thai` enum('Chờ xử lý','Đang tiến hành','Hoàn thành','Hủy','Chờ Hoàn Tất Bảo Hành','Chờ Xem Xét') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ghiChuAdmin` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `thongtinthietbi_id` (`thongtinthietbi_id`),
  KEY `nhanvien_id` (`nhanvien_id`),
  KEY `phong_id` (`phong_id`),
...
INSERT INTO `lichbaoduong` VALUES (25,206,2,1,'2025-04-25','Bảo dưỡng định kỳ phòng A1.1','Hoàn thành',1,'2025-04-24 01:10:19','2025-04-24 20:19:52',1,NULL),(26,177,2,1,'2025-04-25','Bảo dưỡng định kỳ phòng A1.1','Hoàn thành',1,'2025-04-24 01:10:19','2025-04-24 20:23:35',1,NULL),(27,178,2,1,'2025-04-25','Bảo dưỡng định kỳ phòng A1.1','Hoàn thành',1,'2025-04-24 01:10:19','2025-04-24 21:32:52',1,NULL),(33,162,2,2,'2025-04-25','Bảo dưỡng định kỳ tại A2.3 (Phòng Học)','Hoàn thành',1,'2025-04-24 22:00:24','2025-04-24 22:00:57',1,NULL),(38,206,2,1,'2025-04-26','asdasd','Hoàn thành',1,'2025-04-25 19:25:46','2025-04-25 20:05:51',1,NULL),(41,206,2,1,'2025-05-01','Bảo dưỡng định kỳ tại A1.1 (Phòng Học)','Hoàn thành',1,'2025-04-25 20:49:15','2025-04-28 23:21:55',1,NULL),(42,166,2,14,'2025-04-27','Bảo dưỡng định kỳ tại E3.3 (Hội Trường)','Chờ xử lý',1,'2025-04-27 10:26:50','2025-04-29 01:56:51',0,NULL),(44,275,2,19,'2025-05-16','kiểm tra bàn phím phòng này','Chờ xử lý',1,'2025-05-16 12:26:38','2025-05-16 12:26:38',0,NULL);
...
INSERT INTO `log_huy_congviec` VALUES (1,37,2,1,'2025-04-15 13:10:41','hủy k làm nữa !!! scam','Đang Tiến Hành'),(4,58,2,1,'2025-04-27 09:53:59','hủy 4:53','Đã Duyệt'),(8,56,2,1,'2025-04-27 10:20:06','huy1','Đã Duyệt'),(9,56,2,1,'2025-04-27 10:34:44','fdg','Đã Duyệt'),(10,56,2,1,'2025-04-27 10:45:24','ew','Đã Duyệt'),(11,56,2,1,'2025-04-27 11:00:37','23','Đang Tiến Hành'),(12,56,2,1,'2025-04-27 11:15:54','12','Đã Duyệt'),(13,56,2,1,'2025-04-27 11:21:42','lk','Đang Tiến Hành'),(14,56,2,1,'2025-04-27 11:33:11','j','Đang Tiến Hành'),(15,56,2,1,'2025-04-27 11:39:43','lj','Đã Duyệt'),(17,56,2,1,'2025-04-28 02:36:08','sdfg','Đã Duyệt'),(18,47,2,1,'2025-04-28 20:08:46','hủy','Đã Duyệt');
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lưu trữ việc phân công phòng cố định cho nhân viên';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nhanvien_phong_phutrach` VALUES (45,3,9,'2025-04-12 16:28:44'),(46,3,7,'2025-04-12 18:29:24'),(47,2,2,'2025-04-14 19:07:13'),(48,20,18,'2025-04-15 12:41:06'),(49,20,19,'2025-04-15 12:41:06'),(50,20,20,'2025-04-15 12:41:06'),(51,2,1,'2025-04-15 12:42:01'),(52,2,3,'2025-04-15 12:42:21'),(53,2,4,'2025-04-15 12:42:21'),(55,20,41,'2025-04-26 18:08:15');
...
INSERT INTO `theloai` VALUES (1,'Laptop'),(2,'Micro'),(3,'Máy In'),(4,'Bóng Đèn'),(5,'Máy Tính'),(6,'Điều Hòa'),(7,'Ghế'),(8,'Bàn'),(9,'Dây Điện'),(10,'Loa'),(11,'Quạt'),(12,'Tai Nghe'),(13,'Sạc Dự Phòng'),(16,'Remote'),(17,'Bàn Phím');
...
CREATE TABLE `thongtinthietbi` (
  ...
  `trangThaiHoatDong` enum('đang dùng','chưa dùng','mất mát','hỏng hóc') NOT NULL DEFAULT 'chưa dùng' COMMENT 'Trạng thái hoạt động thực tế',
...
INSERT INTO `thongtinthietbi` VALUES (150,2,11,NULL,'Bóng Đèn Huỳnh Quang',67,NULL,120000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(151,2,11,NULL,'Bóng Đèn Huỳnh Quang',67,NULL,120000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(152,2,NULL,NULL,'Bóng Đèn Huỳnh Quang',67,NULL,120000.00,'chưa dùng','con_bao_hanh',12,'2026-03-30',NULL),(153,2,NULL,NULL,'Bóng Đèn Huỳnh Quang',67,NULL,120000.00,'chưa dùng','con_bao_hanh',12,'2026-03-30',NULL),(154,2,NULL,NULL,'Bóng Đèn Huỳnh Quang',67,NULL,120000.00,'chưa dùng','con_bao_hanh',12,'2026-03-30',NULL),(155,3,4,'Lê Khải','Micro Shure SM58',67,NULL,310000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(156,3,4,NULL,'Micro Shure SM58',67,NULL,310000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(157,3,4,'Minh Hùng','Micro Shure SM58',67,NULL,310000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(158,3,NULL,NULL,'Micro Shure SM58',67,NULL,310000.00,'chưa dùng','con_bao_hanh',12,'2026-03-30',NULL),(159,3,NULL,NULL,'Micro Shure SM58',67,NULL,310000.00,'chưa dùng','con_bao_hanh',12,'2026-03-30',NULL),(160,4,2,NULL,'Micro AKG D5',73,NULL,275000.00,'đang dùng','cho_thanh_ly',12,'2026-03-30',NULL),(161,4,NULL,NULL,'Micro AKG D5',73,NULL,275000.00,'chưa dùng','da_bao_hanh',12,'2026-03-30',NULL),(162,4,2,NULL,'Micro AKG D5',73,NULL,275000.00,'hỏng hóc','het_bao_hanh',12,'2026-03-30',NULL),(163,4,3,NULL,'Micro AKG D5',73,NULL,275000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(164,4,3,NULL,'Micro AKG D5',73,NULL,275000.00,'đang dùng','con_bao_hanh',12,'2026-03-30',NULL),(165,6,NULL,NULL,'Máy In Canon PIXMA',74,NULL,18500000.00,'chưa dùng','con_bao_hanh',36,'2028-03-30',NULL),(166,6,14,NULL,'Máy In Canon PIXMA',74,NULL,18500000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(167,7,NULL,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'chưa dùng','da_thanh_ly',14,'2026-05-30',NULL),(168,7,NULL,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'chưa dùng','da_thanh_ly',14,'2026-05-30',NULL),(169,7,NULL,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'chưa dùng','da_thanh_ly',14,'2026-05-30',NULL),(170,7,NULL,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'chưa dùng','da_thanh_ly',14,'2026-05-30',NULL),(171,7,NULL,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'chưa dùng','da_thanh_ly',14,'2026-05-30',NULL),(172,7,NULL,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'chưa dùng','het_bao_hanh',14,'2026-05-30',NULL),(173,7,7,NULL,'Bóng Đèn Philips LED',74,NULL,150000.00,'đang dùng','con_bao_hanh',14,'2026-05-30',NULL),(174,8,15,NULL,'Bóng Đèn Rạng Đông',75,NULL,160000.00,'đang dùng','con_bao_hanh',24,'2027-03-30',NULL),(175,8,15,NULL,'Bóng Đèn Rạng Đông',75,NULL,160000.00,'đang dùng','con_bao_hanh',24,'2027-03-30',NULL),(176,8,15,NULL,'Bóng Đèn Rạng Đông',75,NULL,160000.00,'đang dùng','con_bao_hanh',24,'2027-03-30',NULL),(177,9,1,NULL,'Laptop MSI',75,NULL,25000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(178,9,1,NULL,'Laptop MSI',75,NULL,25000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(179,18,NULL,NULL,'Desktop Gaming',76,NULL,20000000.00,'chưa dùng','con_bao_hanh',36,'2028-03-30',NULL),(180,20,12,NULL,'Airpod Pro 2025',76,NULL,4000000.00,'đang dùng','con_bao_hanh',28,'2027-07-30',NULL),(181,20,12,NULL,'Airpod Pro 2025',76,NULL,4000000.00,'đang dùng','con_bao_hanh',28,'2027-07-30',NULL),(182,20,12,NULL,'Airpod Pro 2025',76,NULL,4000000.00,'đang dùng','con_bao_hanh',28,'2027-07-30',NULL),(184,21,NULL,NULL,'Máy In Hp',78,NULL,18000000.00,'chưa dùng','con_bao_hanh',34,'2028-01-30',NULL),(185,21,13,NULL,'Máy In Hp',79,NULL,18000000.00,'đang dùng','con_bao_hanh',23,'2027-02-28',NULL),(186,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(187,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(188,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(189,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(190,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(191,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(192,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(193,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(194,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(195,22,NULL,NULL,'Bàn Học ',80,NULL,300000.00,'chưa dùng','con_bao_hanh',45,'2028-12-30',NULL),(196,22,18,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(197,22,18,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(198,22,18,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(199,22,17,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(200,22,17,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(201,22,16,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(202,22,16,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(203,22,10,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(204,22,10,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(205,22,1,NULL,'Bàn Học ',80,NULL,300000.00,'đang dùng','con_bao_hanh',45,'2028-12-30',NULL),(206,23,1,NULL,'Laptop HP',81,NULL,11000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(207,23,6,NULL,'Laptop HP',81,NULL,11000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(208,23,6,NULL,'Laptop HP',81,NULL,11000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(209,23,6,NULL,'Laptop HP',81,NULL,11000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(210,23,11,NULL,'Laptop HP',81,NULL,11000000.00,'đang dùng','con_bao_hanh',36,'2028-03-30',NULL),(224,23,11,NULL,'Laptop HP',89,NULL,11000000.00,'đang dùng','con_bao_hanh',72,'2031-04-09',NULL),(247,25,9,NULL,'Ghế học',94,NULL,200000.00,'đang dùng','het_bao_hanh',2,'2025-06-10',NULL),(248,25,9,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(249,25,9,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(250,25,9,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(251,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(252,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(253,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(254,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(255,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(256,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(257,25,7,NULL,'Ghế học',95,NULL,200000.00,'đang dùng','het_bao_hanh',1,'2025-05-12',NULL),(258,20,NULL,NULL,'Airpod Pro 2025',96,NULL,4000000.00,'chưa dùng','con_bao_hanh',12,'2026-04-20',NULL),(259,20,NULL,NULL,'Airpod Pro 2025',96,NULL,4000000.00,'chưa dùng','con_bao_hanh',12,'2026-04-20',NULL),(260,26,NULL,NULL,'Loa JBL',97,NULL,12000000.00,'chưa dùng','con_bao_hanh',12,'2026-04-21',NULL),(261,26,NULL,NULL,'Loa JBL',98,'2025-04-21',12000000.00,'chưa dùng','con_bao_hanh',12,'2026-04-21',NULL),(262,26,NULL,NULL,'Loa JBL',98,'2025-02-12',140000.00,'chưa dùng','con_bao_hanh',12,'2026-02-12',NULL),(263,26,NULL,NULL,'Loa JBL',99,'2025-04-22',12000000.00,'chưa dùng','con_bao_hanh',12,'2026-04-22',NULL),(264,4,NULL,NULL,'Micro AKG D5',100,'2026-12-12',275000.00,'chưa dùng','con_bao_hanh',12,'2027-12-12',NULL),(265,20,NULL,NULL,'Airpod Pro 2025',101,'2025-04-21',4000000.00,'chưa dùng','con_bao_hanh',12,'2026-04-21',NULL),(266,20,NULL,NULL,'Airpod Pro 2025',101,'2025-04-30',5000000.00,'chưa dùng','con_bao_hanh',22,'2027-03-02',NULL),(267,9,NULL,NULL,'Laptop MSI',102,'2025-04-30',25000000.00,'chưa dùng','het_bao_hanh',12,'2025-05-05',NULL),(268,30,NULL,NULL,'Laptop Dell',103,'2025-04-25',8000000.00,'chưa dùng','da_thanh_ly',24,'2027-04-25',NULL),(269,31,NULL,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'chưa dùng','con_bao_hanh',24,'2027-05-16',NULL),(270,31,NULL,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'chưa dùng','con_bao_hanh',24,'2027-05-16',NULL),(271,31,NULL,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'chưa dùng','con_bao_hanh',24,'2027-05-16',NULL),(272,31,NULL,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'chưa dùng','con_bao_hanh',24,'2027-05-16',NULL),(273,31,NULL,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'chưa dùng','con_bao_hanh',24,'2027-05-16',NULL),(274,31,19,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'đang dùng','con_bao_hanh',24,'2027-05-16',NULL),(275,31,19,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'đang dùng','con_bao_hanh',24,'2027-05-16',NULL),(276,31,19,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'đang dùng','con_bao_hanh',24,'2027-05-16',NULL),(277,31,19,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'đang dùng','con_bao_hanh',24,'2027-05-16',NULL),(278,31,19,NULL,'Bàn phím Logitech',104,'2025-05-16',168000.00,'đang dùng','con_bao_hanh',24,'2027-05-16',NULL);
...
-- Dump completed on 2025-05-20 14:07:30
