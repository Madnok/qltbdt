...
const ChiTietTheLoai = ({ record, onClose, refreshData }) => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_URL}/theloai/${record.id}`, {withCredentials: true})
            .then(response => {
    ...
    const handleSave = async () => {
        ...
        try {
            await axios.put(`${process.env.REACT_APP_API_URL}/theloai/${record.id}`, editData, config);
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/theloai/${record.id}`, {withCredentials: true});
