...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <div className="px-4 py-4 flex flex-row text-gray-300 bg-gray-900 shadow-lg gap-48">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        {/* Ô tìm kiếm */}
        <div className="pl-20 relative hidden w-2/5 md:block">
          <input
            type="text"
            placeholder="Tìm kiếm thiết bị, phòng học..."
            className="w-full px-4 py-2 text-sm text-gray-900 bg-white border rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
          />
          <i className="absolute text-gray-500 transform -translate-y-1/2 right-4 top-1/2 fas fa-search"></i>
        </div>

        {/* Avatar + Dropdown */}
        <div className="pl-40 relative hidden w-80 md:block">
          <button
